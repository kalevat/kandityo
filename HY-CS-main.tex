...
\supervisors{Prof. Keijo Heljanko, FM. Ilari Maarala}
...
\include{Ch.1_Johdanto}
\include{Ch.2_Tapaustutkimus}
\include{Ch.3_Konesalipalvelut}
\include{Ch.4_Palvelunlaatu}
\include{Ch.5_Vertailu}
\include{Ch.6_Analyysi}
\include{Ch.7_Yhteenveto}
